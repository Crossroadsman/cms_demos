...
TEMPLATES = [
    {
        ...
        'DIRS': [
            'templates',  # required by Django CMS
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# Media files
# see Django docs and Django CMS docs:
# http://docs.django-cms.org/en/latest/how_to/install.html#media-and-static-file-handling

MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')


# Other DjangoCMS-Specific settings:
CMS_TEMPLATES = [
